        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("⌯✧مبرمج السورس✧⌯", url=f"https://t.me/k333k1"),
                ],
                [
                    ...
                    InlineKeyboardButton(
                        "‹ ⌯✧𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝙻 𝙼𝙴𝙼✧⌯ ›", url=f"https://t.me/W_D_9"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/11e8883bd616ee3c0e255.jpg",
        caption=f"""Programmer (GNAZA)(https://t.me/W_D_9) GNAZA""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("⌯✧𝑆𝑂𝐔𝑅𝐶𝐸  𝐴𝐿 𝑀𝐸𝑀✧⌯", url=f"https://t.me/W_D_9"),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton("⌯✧لتنصيب البوت✧⌯", url=f"https://t.me/k333k"),
            ]
         ]
     )
  )
